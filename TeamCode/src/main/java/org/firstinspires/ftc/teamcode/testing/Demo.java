...
public class Demo extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        DemoBot bot = new DemoBot(hardwareMap, telemetry, gamepad1, gamepad2,false);
        bot.teleopInit();
        waitForStart();
        bot.teleopStart();
...
class DemoBot extends BotPeriodics {
    ...
    public DemoBot(HardwareMap hardwareMap, Telemetry tele, Gamepad gamepad1, Gamepad gamepad2, boolean twoMovement) {
