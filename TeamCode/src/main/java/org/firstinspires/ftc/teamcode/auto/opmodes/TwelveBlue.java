...
public class TwelveBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d intake3Pose1 = new Pose2d(INTAKE_X + INTAKE_FORWARD_DIST, INTAKE3_Y, Math.toRadians(0));
        Pose2d intake3Pose2 = new Pose2d(INTAKE_X + 2 * INTAKE_FORWARD_DIST, INTAKE3_Y, Math.toRadians(0));
        ...
        */
        ...
        Action toIntakeStart3 = drive.actionBuilder(shootingPose)
                ...
                .build();
        Action toIntake3_1 = new ParallelAction(
