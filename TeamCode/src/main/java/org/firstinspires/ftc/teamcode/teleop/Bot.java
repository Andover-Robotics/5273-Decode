...
public class Bot {
    ...
    private final int RUMBLE_BLIPS = 3;
    private final int LED_DURATION = 500;
    private boolean alreadyRumbled = false;
    ...
    public void teleopTick() {
        ...
        if (g1.wasJustPressed(GamepadKeys.Button.BACK)) {
            ...
            g1.gamepad.setLedColor(0,0,1,LED_DURATION);
            g1.gamepad.rumbleBlips(RUMBLE_BLIPS - 1);
        }
        ...
        if (g1.wasJustPressed(GamepadKeys.Button.START)) {
            ...
            g1.gamepad.setLedColor(1,0,0,LED_DURATION);
            g1.gamepad.rumbleBlips(RUMBLE_BLIPS - 1);
        }
        ...
        if(!alreadyRumbled && indexer.isLoaded()){
            g1.gamepad.rumbleBlips(RUMBLE_BLIPS);
            g2.gamepad.rumbleBlips(RUMBLE_BLIPS);
            alreadyRumbled = true;
        }
