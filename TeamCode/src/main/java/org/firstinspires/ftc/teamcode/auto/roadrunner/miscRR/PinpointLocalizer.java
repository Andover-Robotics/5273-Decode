...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 983.0489334801409; // y position of the parallel encoder (in tick units)
        public double perpXTicks =  -3021.3217014610577; // x position of the perpendicular encoder (in tick units)
    }
