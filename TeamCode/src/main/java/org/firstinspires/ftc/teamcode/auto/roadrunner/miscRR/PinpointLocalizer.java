...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2817.655557; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1383.670139   ; // x position of the perpendicular encoder (in tick units)
    }
